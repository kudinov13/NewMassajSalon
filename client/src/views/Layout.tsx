...
const BASE_SCHEMAS = {
  localBusiness: {
    ...
    "description": "Массаж (расслабляющий, классический, лимфодренажный, массаж спины), тибетские поющие чаши, виброакустический массаж, диагностика по внешним признакам и онлайн-курсы в Бийске и Новосибирске.",
    "priceRange": "₽₽",
  ...
  massageService: {
    "@type": "Service",
    "name": "Массаж в Бийске и Новосибирске",
    "description": "Расслабляющий, классический, лимфодренажный массаж и массаж спины в Бийске и Новосибирске.",
    "areaServed": [{"@type": "City", "name": "Бийск"}, {"@type": "City", "name": "Новосибирск"}],
